...
def test_pearl_on_position_gain():
    ...
    module.evaluate(
        CrewChiefFrameContext(
            ...
            strategy={},
            session={"phase": "race", "session_type_int": 10, "enable_pearl_messages": True},
            now_monotonic=0.5,
        )
    )
    ctx = CrewChiefFrameContext(
        ...
        strategy={},
        session={"phase": "race", "session_type_int": 10, "enable_pearl_messages": True, "verbosity_level": "normal"},
        now_monotonic=1.0,
    )
