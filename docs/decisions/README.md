...
Registro de decisiones técnicas relevantes para humanos y agentes IA.
...
Nuevos ADR: `ADR-NNN-titulo-corto.md` con secciones **Context**, **Decision**, **Alternatives**, **Consequences**.
